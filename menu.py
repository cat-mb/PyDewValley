...
class Menu:
    def __init__(self, player, toggle_menu):
        ...
        self.font = pygame.font.Font('/Users/cat/Desktop/PyDewValley/font/LycheeSoda.ttf', 30)
    ...
    def setup(self):
        ...
        for item in self.options:
            ...
            # for each text entry, the text is only one part in the middle, should be space between top and bottom of text
    ...
    def input(self):
        ...
        # if we are going below 0, we are going to the end of the list
        if self.index < 0:
            self.index = len(self.options) - 1
        # if we are going above 0, we are going to the top of the list
    ...
    def show_entry(self, text_surf, amount, top, selected):
        ...
        # show specific entry ONLY if selected
        if selected:
    ...
    def update(self):
        ...
        for text_index, text_surf in enumerate(self.text_surfs):
            # by default, we are getting the top of rectangle, for every item we want to get the distance from text index
